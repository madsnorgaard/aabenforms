...
final class DigitalPost {
   ...
   * @param Sender $sender
   * @param string $subject Message subject (1..255 chars).
   * @param string $body Message body. HTML allowed for Digital Post; stripped
   *   for NemSMS by the transport.
   * @param list<Attachment> $attachments
   * @param string $type One of the TYPE_* constants.
   * @param array<string, string|int|bool> $meta Additional hints:
