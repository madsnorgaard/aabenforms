...
class MultiPartyWorkflowTest extends KernelTestBase {
  ...
  public function testParentCaseWorkerWorkflow(): void {
    ...
    $mitidAction = $this->actionManager->createInstance(
    ...
    $cprAction = $this->actionManager->createInstance(
    ...
    $auditAction = $this->actionManager->createInstance(
